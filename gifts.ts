...
const gifts: IGift[] = [
    ...
    },
    {
        ...
        whish: 'Ты самый близкий для меня человек и я уверен ты навсегда такой и останешься, твои милые, зеленые, приятные глазки всегда будут вызывать бабочек у меня в животе🦋',
        img: '/day7.png'
    },
    {
        id: 8,
    ...
    },
    {
        ...
        whish: 'Ты моя первая любовь, первые крепкие объятия, первый поцелуй, первая ночевка, первый секс, первый человек кому я так доверяю, я очень рад, что все это я испытал именно с тобой, у меня навсегда останутся с тобой самые теплые и приятные воспоминания',
        img: '/day9.png'
    },
    {
        id: 10,
